...
export default function Order() {
    ...
    const handleUploadFrontCccd = (e) => {
        ...
        if (file) {
            setInput((prev) => {
                return { ...prev, identityFront: file };
            });
            fileToDataUri(file).then((url) => setFrontCccd(url));
        } else setFrontCccd("");
    };
    ...
    const handleUploadBackCccd = (e) => {
        ...
        if (file) {
            setInput((prev) => {
                return { ...prev, identityBack: file };
            });
            fileToDataUri(file).then((url) => setBackCccd(url));
        } else setBackCccd("");
    };
    ...
    const handleUploadAvatar = (e) => {
        ...
        if (file) {
            ...
            fileToDataUri(file).then((url) => setAvatar(url));
        } else setAvatar("");
    };
        ...
        <div>
            ...
            {step === 1 ? (
                <div className="mx-[100px] my-[50px]">
                    <span className="bg-[#E6DFF9] text-[30px] py-[10px] px-[30px] rounded-[20px]">Mong muốn của bạn:</span>
                    <div className="grid grid-cols-2 bg-[#CFEAE1] my-[30px] py-[50px] px-[100px] gap-x-[200px] gap-y-[20px] rounded-[20px]">
                        <div className="flex items-center justify-between">
                            Giới tính
                            <select className="select select-primary" onChange={handleChangeInput("gender")}>
                                <option>Nam</option>
                                <option>Nữ</option>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <select className="select select-primary" onChange={handleChangeInput("currentPeopleNum")}>
                                {[...Array(6)].map((el, i) => (
                        ...
                        <div className="flex items-center justify-between">
                            Số lượng người
                            <select className="select select-primary" onChange={handleChangeInput("wantedPeopleNum")}>
                                {[...Array(6)].map((el, i) => (
                                    <option key={i} value={i + 1}>
                                        {i + 1}
                                    </option>
                        ...
                        <div className="flex items-center justify-between">
                            Khoảng giá
                            <select className="select select-primary" onChange={handleChangePrice}>
                                {[...Array(6)].map((el, i) => (
                        ...
                        <div className="flex items-center justify-between">
                            Loại căn
                            <select className="select select-primary" onChange={handleChangeInput("homeType")}>
                        ...
                        <div className="flex items-center justify-between">
                            Nội thất tối thiểu
                            <select className="select select-primary" onChange={handleChangeInput("minFurniture")}>
                    ...
                    <div className="text-right">
                        <button className="btn bg-[#E3EFF8] rounded-[20px] px-[50px]" onClick={handleNextStep}>
                            Tiếp theo
                        </button>
                    </div>
                </div>
                ...
                <div>
                    <div className="mx-[100px] my-[50px]">
                        <div className="bg-[#FFFEF5] my-[30px] py-[50px] px-[100px] rounded-[20px]">
                            <span className="bg-[#C9E7FC] text-[30px] py-[10px] px-[30px] rounded-[20px]">Thông tin cá nhân</span>
                            <input
                                type="text"
                            ...
                            <span className="bg-[#C9E7FC] text-[30px] py-[10px] px-[30px] rounded-[20px]">Xác minh thông tin</span>
                            <div className="grid grid-cols-2 gap-20 mt-[50px]">
                                <div className="border border-black rounded-[20px] p-[20px]">
                                    ...
                                    />
                                    {frontCccd ? <img src={frontCccd} alt="" className="mt-[20px]"></img> : <></>}
                                </div>
                                <div className="border border-black rounded-[20px] p-[20px]">
                                    ...
                                    />
                                    {backCccd ? <img src={backCccd} alt="" className="mt-[20px]"></img> : <></>}
                                </div>
                            </div>
                            <div className="border border-black rounded-[20px] p-[20px] mt-[30px] w-[40%] mx-auto">
                                ...
                                />
                                {avatar ? <img src={avatar} alt="" className="mt-[20px]"></img> : <></>}
                            </div>
                        </div>

                        <div className="text-right">
                            <button className="btn bg-[#FFD700] rounded-[20px] px-[30px]" onClick={handlePayment}>
                                Thanh toán (50.000đ)
                            </button>
                        </div>
                    </div>
